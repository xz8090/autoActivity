...
public class ChaoJiYing {
	...
	private static String username = LoadPropertiesUtil.getKey("info.properties", "chaojiyingID");
	private static String password = LoadPropertiesUtil.getKey("info.properties", "chaojiyingPWD");
	private static String softid = LoadPropertiesUtil.getKey("info.properties", "chaojiyingSOFTID");
	private static String codetype = LoadPropertiesUtil.getKey("info.properties", "chaojiyingCODETYPE");
	...
	//根据图片的byte数组识别并返回对象
	public static String bytes2Object(byte[] byteArr) {
		String result = "";
		String param = String
		.format(
				"user=%s&pass=%s&softid=%s&codetype=%s&len_min=%s", username, password, softid, codetype, len_min);
	...
	//报告当前账号识别的错误
	public static String ReportNowError(String id) {
	...
	public static void main(String[] args){
		//System.out.println("a8sY0".toUpperCase());
	}
